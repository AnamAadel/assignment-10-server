...
const uri = `mongodb+srv://${process.env.USERNAME_KEY}:${process.env.PASSWORD}@cluster0.otazdf5.mongodb.net/?retryWrites=true&w=majority`;
...
app.get("/products/:id", async (req, res)=> {
    ...
    const heroProductData = await newProductCollection.findOne(query);
